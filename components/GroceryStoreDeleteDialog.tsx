...
interface GroceryStoreDeleteDialogProps {
  storeId: Id<"grocery_stores">;
  storeName: string;
  onClose: () => void;
}

export default function GroceryStoreDeleteDialog({
  storeId,
  storeName,
  onClose,
}: GroceryStoreDeleteDialogProps) {
    ...
    >
      ...
      >
        ...
        <p className="mb-1 text-sm text-gray-600 dark:text-gray-400">
          Are you sure you want to delete <span className="font-medium text-gray-900 dark:text-gray-100">{storeName}</span>?
        </p>
        <p className="mb-4 text-sm text-gray-500 dark:text-gray-400">
          This will remove the store from all grocery items.
        </p>
